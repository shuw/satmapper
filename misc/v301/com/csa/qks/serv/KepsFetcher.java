...
public boolean buildSatsFromKeps(String file) {
    ...
    this.theSats = new Vector();
        ...
        while (mySats.hasMoreElements()) {
            ...
            while (myList.hasMoreElements()) {
                ...
                if (mySat.getName().equals(satName.trim())) {
...
public void run() {
    ...
    try {
			com.csa.qks.cont.SerializedCanSats canSats = new com.csa.qks.cont.SerializedCanSats();
